...
const YourDetails = ({text, mainColour, href, icon, onPrevStep}) => {
    ...
    return (
        ...
        <div className={`bg-beige rounded-xl pt-5 md:p-9 md:shadow-xl ${isHidden ? 'hidden md:block': 'block'}`}>
            ...
            <div onClick={onPrevStep}><button className="my-4 mb-2 md:mb-0 border border-charcoal md:hover:bg-charcoal md:hover:text-beige p-3 text-center text-sm w-full uppercase">Edit Details</button></div>
